...
user.config( function($stateProvider, $urlRouterProvider, $qProvider) {
...
user.directive('rowUser', function(){
  return {
    templateUrl: 'user-row.html'
  };
});
user.directive('modalUser', function(){
  return {
    restrict: 'E',
    scope: {
      userView: '='
...
user.directive('modalAlert', function(){
  return {
    restrict: 'E',
